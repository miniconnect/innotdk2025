...
public class ChemistryTopic implements Topic {
    ...
    private static final Keyword[] secondaryKeywords = {
            ...
            KeywordEnum.CONDENSED_MAT.keyword(),
    ...
    public ChemistryTopic(NLGFactory factory, Realiser realiser) {
    ...
    private static class TopicTextGenerator extends TextGeneratorBase {
        ...
        public String generateTitle() {
            return "Some chemistry paper";
        }

        public String generateAbstract() {
            return "Lorem ipsum dolor sit amet molecule.";
        }
