...
public class PhysicsTopic implements Topic {
    ...
    public PhysicsTopic(NLGFactory factory, Realiser realiser) {
    ...
    private static class TopicTextGenerator extends TextGeneratorBase {
        ...
        public String generateTitle() {
            return "Some physics paper";
        }

        public String generateAbstract() {
            return "Lorem ipsum dolor sit amet elecron.";
        }
